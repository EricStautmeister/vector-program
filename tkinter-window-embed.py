...
x_entry = tk.Entry(master=vector_frame)
y_entry = tk.Entry(master=vector_frame)
z_entry = tk.Entry(master=vector_frame)
...
x_org = tk.Entry(master=vector_frame)
y_org = tk.Entry(master=vector_frame)
z_org = tk.Entry(master=vector_frame)
